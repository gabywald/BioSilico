...
import gabywald.crypto.data.composition.DataBaseCrossRef;
import gabywald.crypto.data.composition.Date;
...
A complete and definitive description of the feature table is given here [https://www.ebi.ac.uk/embl/Documentation/FT_definitions/feature_table.html].
	...
	public static final Pattern[] EMBL_DATA_PATTERNS = {
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 0][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 1][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 2][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 3][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 4][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 5][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 6][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 7][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 8][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[ 9][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[10][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[11][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[12][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[13][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[14][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[15][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[16][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[17][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[18][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[19][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[20][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[21][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[22][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[23][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[24][1]),
		Pattern.compile(EmblFormat.EMBL_DATA_KEYS_PATTERNS[25][1]),
	...
	public static List<EmblFormat> fromString(String content) {
