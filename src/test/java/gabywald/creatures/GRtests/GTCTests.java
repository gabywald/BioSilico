...
public class GTCTests extends TestCase {
	...
	public void testGTC001() {
		...
		GeneticFileContentOld gtc = new GeneticFileContentOld("resources/creatures/creaturesOriginals/dad1.gen");
	...
	public void testGTC003() {
		GeneticFileContentOld gtc = new GeneticFileContentOld("resources/creatures/creaturesOriginals/mum1.gen");
		if (gtc.isReaded()) {
			Logger.printlnLog(LoggerLevel.LL_INFO, "-- " + gtc.length() + "");
			for (int i = 0 ; i < gtc.length() ; i++) {
				// Logger.printlnLog(LoggerLevel.LL_INFO, "[" + i + "]");
	...
	public void testGTC004() {
		GeneticFileContentOld gtc = new GeneticFileContentOld("resources/creatures/creaturesOriginals/Gren.gen");
		if (gtc.isReaded()) {
			Logger.printlnLog(LoggerLevel.LL_INFO, "-- " + gtc.length() + "");
			for (int i = 0 ; i < gtc.length() ; i++) {
				// Logger.printlnLog(LoggerLevel.LL_INFO, "[" + i + "]");
...
//	}
	...
	public void testGTC001bis() {
		// final String dir = System.getProperty("user.dir");
        // System.out.println("current dir = " + dir);
		GeneticFileContent gtc = new GeneticFileContent("resources/creatures/creaturesOriginals/dad1.gen");
	...
	public void testGTC003bis() {
		GeneticFileContent gtc = new GeneticFileContent("resources/creaturesOriginals/mum1.gen");
		while (gtc.isReadable()) {
			char tmpChar = gtc.nextChar();
			if ( (tmpChar != -1) /** && (GeneticFileContent.isAlphaNumeric(tmpChar)) */ ) {
				Logger.printlnLog(LoggerLevel.LL_INFO, "-- [" + tmpChar + "]");
	...
	public void testGTC004bis() {
		GeneticFileContent gtc = new GeneticFileContent("resources/creaturesOriginals/Gren.gen");
		while (gtc.isReadable()) {
			char tmpChar = gtc.nextChar();
			if ( (tmpChar != -1) /** && (GeneticFileContent.isAlphaNumeric(tmpChar)) */ ) {
				Logger.printlnLog(LoggerLevel.LL_INFO, "-- [" + tmpChar + "]");
	...
	public void testGTC007() {
		String genomeFile = "resources/creatures/creaturesOriginals/dad1.gen";
	...
	public void testGTC008() {
		String genomeFile = "resources/creatures/creaturesOriginals/mum1.gen";
		List<CreatureGene> genome = CreatureGeneFactory.readGenome(genomeFile);
	...
	public void testGTC009() {
		String genomeFile = "resources/creatures/creaturesOriginals/Gren.gen";
		List<CreatureGene> genome = CreatureGeneFactory.readGenome(genomeFile);
