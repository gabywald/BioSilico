...
my $link = "http://creaturescaves.com/downloads.php?section=Creatures&game=C1&species=&sortBy=ID&availability=&gender=&searchFor=&page=";
...
for (my $pageIndex = 1 ; $pageIndex < 11 ; $pageIndex++) {
