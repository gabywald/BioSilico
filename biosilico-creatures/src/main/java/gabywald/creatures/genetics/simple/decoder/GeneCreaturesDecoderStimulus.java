 ...
 */
public class GeneCreaturesDecoderStimulus extends GeneCreaturesDecoder {

	public GeneCreaturesDecoderStimulus() 
		{ super(Arrays.asList("2-0")); }
	...
	public String decodeFrom(ICreaturesGene inputGene) {
		...
		sbToReturn.append( "\t Type -------: [" ).append( contents.get(0) ).append( "]\n" );
		sbToReturn.append( "\t Significance: [" ).append( contents.get(1) ).append( "]\n" );
		sbToReturn.append( "\t SensoryNeuro: [" ).append( contents.get(2) ).append( "]\n" );
		sbToReturn.append( "\t Intensity --: [" ).append( contents.get(3) ).append( "]\n" );
		sbToReturn.append( "\t Flags ------: [" ).append( GeneCreaturesDecoder.getStimulusFlags( contents.get(4) ) ).append( "]\n" );
