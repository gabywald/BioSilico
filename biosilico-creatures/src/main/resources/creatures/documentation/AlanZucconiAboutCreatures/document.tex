...
\texttt{https://www.alanzucconi.com/2020/07/27/the-ai-of-creatures/}~\\
\huge{The AI of Creatures}~\\
\large{Alan Zucconi}~\\
...
\begin{minipage}[ht]{0.45\textwidth}
	\includegraphics[width=0.90\textwidth]{creatures_sciam_1997.png}
	%% \captionof{figure}{creatures\_sciam\_1997.png}
	%% \label{fig:creatures\_sciam\_1997.png}
\end{minipage} \hfill \begin{minipage}[ht]{0.54\textwidth}
	\framebox[0.85\textwidth][c]{%
	\begin{minipage}[ht]{0.75\textwidth}
		$\ast$ $\star$ \textbf{Small Furry Creatures}~\\~\\
...
\subsection*{The World of Albia}

Creature’s secret lies hidden in the complex and interactive ecosystem that it models, which provides the perfect ground for emergent behaviours. Norns live on Albia, a disk-shaped planet which features a variety of different environments. Caves, Mountains, Islands, Beaches. And the remnants of an ancient civilization which is nowhere to be found.~\\
...
\begin{minipage}[ht]{0.90\textwidth}
	\includegraphics[width=0.90\textwidth]{Background_C1.png}
	%% \captionof{figure}{Background_C1.png}
	%% \label{fig:Background_C1.png}
\end{minipage}

\subsection*{The Agents}

Albia is actually static, being little more than a fancy background, but it is filled with dozens of agents: objects that the Norns can interact with for things like food, entertainment and transportation. Each object is a small program in itself, written in an assembly-like language called Creatures Agent Object Script—CAOS, for short. --- Creatures is, effectively, an interpreter that executes CAOS code. Which allowed players to customise virtually every aspect of the game.~\\

%%% CAOS !!!!!

\framebox[0.75\textwidth][c]{%
\begin{minipage}[ht]{0.75\textwidth}
	$\ast$ $\star$ \textbf{CAOS}~\\
...
%\end{verbatim*}
	...
	Creatures Caves (\texttt{https://www.creaturescaves.com/community.php?category=\&searchFor=CAOS+Chaos+7C\&section=Resources}) is currently one of the few places still available where you can learn how to code in the CAOS language.

\end{minipage} } % end fbox

\subsection*{The Creatures}

The world of Albia is also inhabited by two main species of creatures: the furry Norns and the vicious Grendels. The game gives life to these creatures by simulating three of the most fundamental processes that keep us alive. -- The vital signs of each creature are controlled by a complex network of chemical reactions, which simulate processes like breathing, eating, and everything in between. --- Within the game, the “Biochemistry” tab of the “Science Kit” offers a chance to peek inside a creature’s bloodstream.~\\

Every action a creature does is decided by a self-organising neural network, which is constantly rewiring itself based on the rewards—and punishments—that are being received.~\\

And all of this, is constructed from a series of instructions, which serve as a digital equivalent of our DNA. Norns can mate with each other, transmitting their physical, biochemical and behavioural traits to their offspring. This is ultimately what allows for real evolution to take place in the small, simulated world of Albia. --- The original Creatures shipped with three breeds of Norns.~\\

\begin{minipage}[ht]{0.30\textwidth}
	\includegraphics[width=0.90\textwidth]{banana-norns.png}
	\captionof{figure}{Banana Norns}
	%% \label{fig:Background_C1.png}
\end{minipage} \hfill \begin{minipage}[ht]{0.25\textwidth}
	\includegraphics[width=0.90\textwidth]{pixie-norns.png}
	\captionof{figure}{Picie Norns}
	%% \label{fig:Background_C1.png}
\end{minipage} \hfill \begin{minipage}[ht]{0.25\textwidth}
	\includegraphics[width=0.90\textwidth]{horse-norns.png}
	\captionof{figure}{Horse Norns}
	%% \label{fig:Background_C1.png}
\end{minipage}
...
\begin{minipage}[ht]{0.90\textwidth}
	\includegraphics[width=0.90\textwidth]{brain_c1_02.png}
	%% \captionof{figure}{brain_c1_02.png}
	%% \label{brain_c1_02.png}
\end{minipage}
...
\begin{minipage}[ht]{0.90\textwidth}
	\includegraphics[width=0.90\textwidth]{brain_c1_03.png}
	%% \captionof{figure}{brain_c1_03.png}
	%% \label{brain_c1_03.png}
\end{minipage}
...
\begin{minipage}[ht]{0.90\textwidth}
	\includegraphics[width=0.90\textwidth]{brain_c1_05.png}
	%% \captionof{figure}{brain_c1_05.png}
	%% \label{brain_c1_05.png}
\end{minipage}
...
\framebox[0.75\textwidth][c]{%
\begin{minipage}[ht]{0.75\textwidth}
	$\ast$ $\star$ \textbf{General Sense Neurons}~\\%
	\begin{tabular}[c]{|c|c|c|}
...
\begin{minipage}[ht]{0.90\textwidth}
	\includegraphics[width=0.90\textwidth]{brain_c1_04.png}
	%% \captionof{figure}{brain_c1_04.png}
	%% \label{brain_c1_04.png}
\end{minipage}

In a well-trained brain, this neuron should strongly contribute to the “push” action since “pushing food” is how creatures eat food, in case you forgot!~\\
...
\framebox[0.75\textwidth][c]{%
\begin{minipage}[ht]{0.75\textwidth}
	$\ast$ $\star$ \textbf{The Genetics Kit}~\\%
	...
	The Genetics Kit is currently available thanks to the Wayback Machine, on an archived page of the now-defunct Creatures Development Network website. You can download the Genetics Kit here, and activating it using Gameware as the username and 100-4492O-1234U-WI as the licence key. Similar versions are available for Creatures 2 and Creatures 3/Docking Station.~\\
\end{minipage}
} % end fbox
...
\begin{minipage}[ht]{0.90\textwidth}
	\includegraphics[width=0.90\textwidth]{brain_c1_06.png}
	%% \captionof{figure}{brain_c1_06.png}
	%% \label{brain_c1_06.png}
\end{minipage}
...
Yet, when a creature is born, those connections are initialised randomly, leaving up to them to learn the best way to form memories and to use them to their advantage. --- Not only was Creatures the first popular game to heavily feature Artificial Life and Artificial Intelligence; it was also the first to rely on Machine Learning.~\\
...
\end{minipage} \hfill \begin{minipage}[ht]{0.25\textwidth}
	\includegraphics[width=0.90\textwidth]{cornwall_small1.jpg}
	%% \captionof{figure}{cornwall_small1.jpg}
	%% \label{cornwall_small1.jpg}
\end{minipage}

For instance, if the creature is eating food while hungry, the connections that led to such an action will get stronger, as the “hunger” drive has been satisfied. On the contrary, if an action puts the creature in danger, the connections responsible will get weakened over time. --- For instance, if a Norn is scared and decides to approach a grendel, their “fear” drive will worsen, weakening the connections that have caused such a poor decision.~\\
...
\begin{minipage}[ht]{0.75\textwidth}
	...
	\begin{minipage}[ht]{0.75\textwidth}
		\includegraphics[width=0.90\textwidth]{instincts.png}
		%% \captionof{figure}{instincts.png}
		%% \label{instincts.png}
	\end{minipage}
...
\end{minipage} \hfill \begin{minipage}[ht]{0.45\textwidth}
	\includegraphics[width=0.90\textwidth]{relaxation.png}
	%% \captionof{figure}{relaxation.png}
	%% \label{relaxation.png}
\end{minipage}

\framebox[0.75\textwidth][c]{%
\begin{minipage}[ht]{0.75\textwidth}
	$\ast$ $\star$ \textbf{State-Variable Rules}~\\%
	
	The State-Variable Rules, often shortened as SV-Rules, are a simple language used by Creatures to define how neurons are updated. --- In the original Creatures, Neurons can have receive connections from two lobes at most. These were referred to as class 0 (D0) and class 1 (D1), where the “D” stands for dendrites. The SV-Rules indicate how data from the D0 and D1 connections is used.~\\
	...
	\begin{minipage}[ht]{0.75\textwidth}
		\includegraphics[width=0.90\textwidth]{svrule_03.png}
		%% \captionof{figure}{svrule_03.png}
		%% \label{svrule_03.png}
	\end{minipage}
	...
	\begin{minipage}[ht]{0.75\textwidth}
		\includegraphics[width=0.90\textwidth]{svrule_01.png}
		%% \captionof{figure}{svrule_01.png}
		%% \label{svrule_01.png}
	\end{minipage}
...
AI  creatures  docking station  grendel  norn  shee
