...
public class BrainView01 extends JFrame {
	...
	private BrainView01() {
		...
		Neuron receptorType = new Neuron(0, 100, 10, 0, 0, 0, false, 0, false);
		...
		Neuron emittersType = new Neuron(0, 100, 10, 8, 16, 4, false, 0, false); ;
		receptorActi.setActivity(200);
		try {
			// (int height, int width, int x, int y, Neuron sample, boolean replace)
			this.testBrain.setLobe(1, this.brainWidth/2, 0, 0, receptorActi, false);
			this.testBrain.setLobe(1, this.brainWidth/2, 0, this.brainWidth/2, receptorType, false);
			this.testBrain.setLobe(this.brainHeight-2, this.brainWidth-7, 1, 3, conception, true);
			this.testBrain.setLobe(1, this.brainWidth, this.brainHeight-1, 0, emittersType, false);
		} 
