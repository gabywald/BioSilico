 ...
 */
public class BrainView03 extends JFrame implements Observer {
	private static final long serialVersionUID = 1L;
	private static BrainView03 instance = null;
	...
	private BrainView03() {
		...
		Neuron conceptionUn = new Neuron (0, 10, 1, 2, 4, 2, false, 2);
	...
	public static BrainView03 getBrainGraphicalView() {
		if (BrainView03.instance == null) 
			{ BrainView03.instance = new BrainView03(); }
		return BrainView03.instance;
	}
	
	public static void main(String[] args) {
		BrainView03 bgv = BrainView03.getBrainGraphicalView();
