 ...
 */
public class BrainView02 extends JFrame implements Observer {
	private static final long serialVersionUID = 1L;
	private static BrainView02 instance = null;
	...
	private BrainView02() {
		...
		receptorActi.setActivity(999);
		Neuron conception = new Neuron (0, 10, 1, 2, 8, 3, false, 2);
	...
	public static BrainView02 getBrainGraphicalView() {
		if (BrainView02.instance == null) 
			{ BrainView02.instance = new BrainView02(); }
		return BrainView02.instance;
	}
	
	public static void main(String[] args) {
		BrainView02 bgv = BrainView02.getBrainGraphicalView();
