 ...
 */
public class AlifeModelView2 implements Observer {
	private static AlifeModelView2 instance = null;
	
	private AlifeModelView2(Organism orga) 
		{ orga.addObserver(this); }
	
	private static AlifeModelView2 getAlifeModelView(Organism orga) {
		if (AlifeModelView2.instance == null) 
			{ AlifeModelView2.instance = new AlifeModelView2(orga); }
		return AlifeModelView2.instance;
	}
	...
	public static void main(String[] args) {
		...
		AlifeModelView2.getAlifeModelView(test);
