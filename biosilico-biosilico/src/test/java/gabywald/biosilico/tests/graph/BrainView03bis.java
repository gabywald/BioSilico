 ...
 */
public class BrainView03bis extends JFrame implements Observer {
	private static final long serialVersionUID = 1L;
	private static BrainView03bis instance = null;
	...
	private BrainView03bis() {
		...
		try {
			this.testBrain = new Brain(20,20);
			...
			/** receptorActi.setActivity(500); */
			Neuron conceptionUn = new Neuron (0, 10, 1, 2, 10, 2, false, 2);
			...
			this.testBrain.setLobe(this.brainHeight-2, this.brainWidth, 1, 0, conceptionUn, true);
			/**
			this.testBrain.setLobe(this.brainHeight-6, this.brainWidth, 1, 0, conceptionUn, true);
	...
	public static BrainView03bis getBrainGraphicalView() {
		if (BrainView03bis.instance == null) 
			{ BrainView03bis.instance = new BrainView03bis(); }
		return BrainView03bis.instance;
	}
	
	public static void main(String[] args) {
		BrainView03bis bgv = BrainView03bis.getBrainGraphicalView();
