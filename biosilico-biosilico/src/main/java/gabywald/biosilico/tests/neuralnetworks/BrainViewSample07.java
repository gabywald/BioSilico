 ...
 */
public class BrainViewSample07 extends JFrame implements Observer {
	private static final long serialVersionUID = 1L;
	private static BrainViewSample07 instance = null;
	...
	private BrainViewSample07() {
		...
		try {
			...
			Neuron receptorPerm = new Neuron(0, 100,  0, 0, 0, 0, false, 0);
			receptorPerm.setActivity( 200 );
			...
			Neuron regulator	= new Neuron(0, 10, 100, 2, 5, 5, false, 0, false);
			
			Neuron emittersTest = new Neuron(0, 10,   5, 4, 4, 3, false, 0, true);

			this.testBrain.setLobe(1, 1, 0, 9, receptorPerm, false);
	...
	public static BrainViewSample07 getBrainGraphicalView() {
		if (BrainViewSample07.instance == null) 
			{ BrainViewSample07.instance = new BrainViewSample07(); }
		return BrainViewSample07.instance;
	}
	
	public static void main(String[] args) {
		BrainViewSample07 bgv = BrainViewSample07.getBrainGraphicalView();
